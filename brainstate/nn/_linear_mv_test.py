...
class TestEventLinear:
    ...
    def test1(self, homo_w, bool_x):
        ...
        m = brainstate.nn.EventLinear(
            20, 40,
            1.5 if homo_w else brainstate.nn.KaimingUniformInit(),
    ...
    def test_grad_bool(self):
        ...
        fn = brainstate.nn.EventLinear(n_in, n_out, brainstate.nn.KaimingUniformInit())
    ...
    def test_jvp(self, bool_x, homo_w):
        ...
        fn = brainstate.nn.EventLinear(
            n_in, n_out, 1.5 if homo_w else brainstate.nn.KaimingUniformInit(),
            float_as_event=bool_x
        )
        w = fn.weight.value
